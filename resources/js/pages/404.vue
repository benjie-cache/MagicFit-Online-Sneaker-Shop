                ...
                <div class="col-lg-6">
                    ...
                    >
                        <span class="title-highlighter highlighter-secondary">
                            <i class="fal fa-exclamation-circle"></i> Oops!
                            Something's missing.</span
                        >
                        <h1 class="title">Page not found</h1>
                        <p>
                            It seems like we dont find what you searched. The
                            page you were looking for doesn't exist, isn't
                            available or its loading incorrectly.
                        </p>
                        <router-link
                            to="/"
...
<script setup>
import notFoundImg from "../../../public/assets/images/others/404.png";
</script>
<style lang=""></style>
